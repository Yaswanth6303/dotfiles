return {
    ...
    config = function()
        ...
        -- set a vim motion to <Space> + r to run the spring boot project in a vim terminal
        vim.keymap.set("n", "<leader>jr", springboot_nvim.boot_run, { desc = "[J]ava [R]un Spring Boot" })
        -- set a vim motion to <Space> + c to open the generate class ui to create a class
        vim.keymap.set("n", "<leader>jc", springboot_nvim.generate_class, { desc = "[J]ava Create [C]lass" })
        -- set a vim motion to <Space> + i to open the generate interface ui to create an interface
        vim.keymap.set("n", "<leader>ji", springboot_nvim.generate_interface, { desc = "[J]ava Create [I]nterface" })
        -- set a vim motion to <Space> + e to open the generate enum ui to create an enum
